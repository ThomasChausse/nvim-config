...
keymap.set("v", "<A-j>", "<cmd>silent! m '>+1<CR>gv=gv", { desc = "Move Lines Down" }) -- Move selected lines down
keymap.set("v", "<A-k>", "<cmd>silent! m '<-2<CR>gv=gv", { desc = "Move Lines Up" })   -- Move selected lines up
